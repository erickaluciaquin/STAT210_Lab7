...
Notes:
First witness is identified as Morty Schapiro (14887), who lives on 4919 Northwestern Dr (the last house on the street). Schapiro describes on the interview that he heard the gun shot and saw the suspect ran out. Suspect is described wearing a 
...
```{r}
#| label: file on witness two: Annabel Miller
witness_two <- person %>%
...
```{r}
#| label: file on witness one: Morty Schapiro
witness_one <- person %>%
